...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO commentDTO1 = new CommentDTO("Boa viagem mano!", Instant.parse("2018-03-21T12:00:00Z"), new AuthorDTO(alex));
        CommentDTO commentDTO2 = new CommentDTO("Aproveite!", Instant.parse("2018-03-22T12:00:00Z"), new AuthorDTO(bob));
        CommentDTO commentDTO3 = new CommentDTO("Tenha um ótimo dia!", Instant.parse("2018-03-23T12:00:00Z"), new AuthorDTO(alex));
